 ...
 *  Minimal, formal y alto contraste; sin verde, bronce ni azul eléctrico.
 *
 *  `FtColors` y `Comensal` se derivan de aquí. Tras cambiar colores, ejecuta
...
export const BRAND = {
  ...
  /** Fondo claro detrás del logo en landing / QR */
  logoBackdrop: '#ffffff',
} as const;

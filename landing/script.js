...
const DOWNLOAD_LINKS = {
  ...
  play: "",
  // Ej.: "https://github.com/AleeSsM/FastTable/releases/latest/download/fasttable.apk"
  apk: "",
};
...
(function () {
  ...
  const flashNote = (msg) => {
    ...
    noteTimer = setTimeout(() => {
      ...
      note.textContent = "* Los enlaces de descarga se activarán al publicar la app.";
    }, 3200);
  };
  ...
  setupStoreButton(
    "apk-btn",
    "apk",
    "La descarga directa (APK) se habilitará en cuanto liberemos la demo."
  );
